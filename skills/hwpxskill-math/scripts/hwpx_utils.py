...
NOTE: validate_xml, update_metadata, pack_hwpx, and validate_hwpx are intentionally
duplicated from hwpxskill/scripts/build_hwpx.py. This duplication is by design:
math-hwpx and hwpxskill are independent git repositories, and cross-repo imports
would create fragile dependencies. Keep both copies in sync when modifying.
"""
